...
extern "C"
{
  ...
  /**
   * @file
   * RTE simple cursor and color support for VT100 using ANSI color escape
   *codes.
   *
   ***/
...
#define _s(_x, _y)                                                            \
  ...
  /** Main routine to set color for foreground and background nd attribute at
   ...
   * position */
  static __inline__ int
  scrn_fgbgcolor_str (char *str, scrn_color_e fg, scrn_color_e bg,
                      scrn_attr_e attr)
  {
   ...
   */
  static __inline__ int
  scrn_color_str (char *str, scrn_color_e fg, scrn_color_e bg,
                  scrn_attr_e attr)
  {
    if ((fg != SCRN_NO_CHANGE) && (bg != SCRN_NO_CHANGE))
   ...
   * supported */
  static __inline__ int
  scrn_rgb_str (char *str, uint8_t fg_bg, scrn_rgb_t r, scrn_rgb_t g,
                scrn_rgb_t b)
  {
