...
extern "C"
{
  ...
  typedef int (*cli_scan_t) (struct cli_node *node, uint32_t flags,
                             args_t *args);
   ...
   */
  int cli_scan_directory (struct cli_node *dir, cli_scan_t func,
   ...
   *   Number of nodes found of this type in the directory
   */
  uint32_t cli_node_list_with_type (struct cli_node *node, uint32_t flags,
                                    void **ret);
   ...
   *   Number of nodes found of this type in the directory
   */
  struct cli_node *cli_search_dir (struct cli_node *dir, const char *name,
                                   uint32_t type);
   ...
   *   Number of nodes found of this type in the directory
   */
  int cli_scan_path (const char *path, cli_scan_t func, uint32_t flags,
                     args_t *args);
