          ...
          do
            {
              ...
              /*
               * section is larger than size build a new rte_heap_entry_t
               * structure in the left over space in this section. nxt_hd is
               * the new pointer to the structure after size.
               */
...
/******************************************************************************
 * simpleMemMalloc - Wrapper routine for simpleMemAlloc insert size into
 * buffer.
 */
void *
