/*-
 *   Copyright(c) <2015-2023>-2016 Intel Corporation. All rights reserved.
 *
...
#define XARGS_MAX_TOKENS 32
  ...
  int cmdline_parse_args (cmdline_parse_token_hdr_t *tk, const char *srcbuf,
                          void *res, unsigned tk_len);
  int cmdline_get_help_args (cmdline_parse_token_hdr_t *tk, char *dstbuf,
                             unsigned int size);
