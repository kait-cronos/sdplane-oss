...
#define LITTLE_ENDIAN 0x1234
  ...
  typedef struct pcap_pkt_data_s
  { /**< Keep these in this order as pkt_seq_t mirrors the first three
       objects */
    ...
    pcaprec_hdr_t
        hdr; /**< Packet header from the .pcap file for each packet */
  } pcap_pkt_data_t;
  ...
  size_t _pcap_read (pcap_info_t *pcap, pcaprec_hdr_t *pHdr, char *pktBuff,
                     uint32_t bufLen);
