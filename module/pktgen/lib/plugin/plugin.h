...
#define PLUGIN_LOG(level, fmt, args...)                                       \
  rte_log (RTE_LOG_##level, libplugin_logtype, "%s(%d): " fmt, __func__,      \
           getpid (), ##args)
...
#define PLUGIN_INFO(_n, _d, _f, _v)                                           \
  struct plugin_info _n##_plugin_info = { .desc = _d,                         \
                                          .start = _n##_start,                \
                                          .stop = _n##_stop,                  \
                                          .pfuncs = (void *) _f,              \
                                          _v }
   ...
   */
  int plugin_get_symbol (struct plugin *pin, const char *symbol_name,
                         char **ret);
