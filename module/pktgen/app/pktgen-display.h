...
extern "C"
{
  ...
  /**
   *
   * pktgen_display_set_color - Changes the color to the color of the specified
   * element.
   *
   * DESCRIPTION
  ...
  /**
   *
   * pktgen_set_theme_item - Set the given item name with the colors and
   * attribute
   *
   * DESCRIPTION
   ...
   * SEE ALSO:
   */
  void pktgen_set_theme_item (char *item, char *fg_color, char *bg_color,
                              char *attr);
