...
extern "C"
{
  ...
  __extension__ typedef void
      *MARKER[0]; /**< generic marker for a point in a structure */
  ...
  typedef struct pkt_seq_s
  {
    ...
    struct cmdline_ipaddr
        ip_src_addr; /**< Source IPv4 address also used for IPv6 */
    ...
    uint16_t
        ether_hdr_size; /**< Size of Ethernet header in packet for VLAN ID */
