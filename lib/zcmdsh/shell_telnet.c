...
telcmds2str (u_char telnet_cmd)
{
  ...
  switch (telnet_cmd)
    {
      case IAC: telnet_cmd_str = "IAC"; break;
      ...
      case SB: telnet_cmd_str = "SB"; break;
      case GA: telnet_cmd_str = "GA"; break;
      case EL: telnet_cmd_str = "EL"; break;
      case EC: telnet_cmd_str = "EC"; break;
      case AYT: telnet_cmd_str = "AYT"; break;
      case AO: telnet_cmd_str = "AO"; break;
      case IP: telnet_cmd_str = "IP"; break;
      case BREAK: telnet_cmd_str = "BREAK"; break;
      case DM: telnet_cmd_str = "DM"; break;
      case NOP: telnet_cmd_str = "NOP"; break;
      case SE: telnet_cmd_str = "SE"; break;
      case EOR: telnet_cmd_str = "EOR"; break;
      case ABORT: telnet_cmd_str = "ABORT"; break;
      case SUSP: telnet_cmd_str = "SUSP"; break;
      case xEOF: telnet_cmd_str = "xEOF"; break;
      default: telnet_cmd_str = ""; break;
    }
...
telopts2str (u_char telnet_opt)
{
  ...
  switch (telnet_opt)
    {
      case TELOPT_BINARY: telnet_opt_str = "BINARY"; break;
      case TELOPT_ECHO: telnet_opt_str = "ECHO"; break;
      case TELOPT_RCP: telnet_opt_str = "RCP"; break;
      case TELOPT_SGA: telnet_opt_str = "SGA"; break;
      case TELOPT_NAMS: telnet_opt_str = "NAMS"; break;
      case TELOPT_STATUS: telnet_opt_str = "STATUS"; break;
      case TELOPT_TM: telnet_opt_str = "TM"; break;
      case TELOPT_RCTE: telnet_opt_str = "RCTE"; break;
      case TELOPT_NAOL: telnet_opt_str = "NAOL"; break;
      case TELOPT_NAOP: telnet_opt_str = "NAOP"; break;
      case TELOPT_NAOCRD: telnet_opt_str = "NAOCRD"; break;
      case TELOPT_NAOHTS: telnet_opt_str = "NAOHTS"; break;
      case TELOPT_NAOHTD: telnet_opt_str = "NAOHTD"; break;
      case TELOPT_NAOFFD: telnet_opt_str = "NAOFFD"; break;
      case TELOPT_NAOVTS: telnet_opt_str = "NAOVTS"; break;
      case TELOPT_NAOVTD: telnet_opt_str = "NAOVTD"; break;
      case TELOPT_NAOLFD: telnet_opt_str = "NAOLFD"; break;
      case TELOPT_XASCII: telnet_opt_str = "XASCII"; break;
      case TELOPT_LOGOUT: telnet_opt_str = "LOGOUT"; break;
      case TELOPT_BM: telnet_opt_str = "BM"; break;
      case TELOPT_DET: telnet_opt_str = "DET"; break;
      case TELOPT_SUPDUP: telnet_opt_str = "SUPDUP"; break;
      case TELOPT_SUPDUPOUTPUT: telnet_opt_str = "SUPDUPOUTPUT"; break;
      case TELOPT_SNDLOC: telnet_opt_str = "SNDLOC"; break;
      case TELOPT_TTYPE: telnet_opt_str = "TTYPE"; break;
      case TELOPT_EOR: telnet_opt_str = "EOR"; break;
      case TELOPT_TUID: telnet_opt_str = "TUID"; break;
      case TELOPT_OUTMRK: telnet_opt_str = "OUTMRK"; break;
      case TELOPT_TTYLOC: telnet_opt_str = "TTYLOC"; break;
      case TELOPT_3270REGIME: telnet_opt_str = "3270REGIME"; break;
      case TELOPT_X3PAD: telnet_opt_str = "X3PAD"; break;
      case TELOPT_NAWS: telnet_opt_str = "NAWS"; break;
      case TELOPT_TSPEED: telnet_opt_str = "TSPEED"; break;
      case TELOPT_LFLOW: telnet_opt_str = "LFLOW"; break;
      case TELOPT_LINEMODE: telnet_opt_str = "LINEMODE"; break;
      case TELOPT_OLD_ENVIRON: telnet_opt_str = "OLD_ENVIRON"; break;
      case TELOPT_AUTHENTICATION: telnet_opt_str = "AUTHENTICATION"; break;
      case TELOPT_ENCRYPT: telnet_opt_str = "ENCRYPT"; break;
      case TELOPT_NEW_ENVIRON: telnet_opt_str = "NEW_ENVIRON"; break;
      case TELOPT_EXOPL: telnet_opt_str = "EXOPL"; break;
      default: telnet_opt_str = ""; break;
    }
...
vty_shell_keyfunc_telnet_opt (struct shell *shell)
{
  ...
  snprintf (telnet_cmd_strbuf, sizeof (telnet_cmd_strbuf),
            ...
            (u_char)shell->telnet_cmd, (u_char)shell->telnet_cmd);

  char *telnet_opt_str;
  char telnet_opt_strbuf[32];

  telnet_opt_str = telopts2str (shell->telnet_opt);
  snprintf (telnet_opt_strbuf, sizeof (telnet_opt_strbuf),
            "%s(%d|%#02x)", telnet_opt_str,
            (u_char)shell->telnet_opt, (u_char)shell->telnet_opt);

  DEBUG_ZCMDSH_LOG (TELNET, "IAC %s %s.",
                    telnet_cmd_strbuf, telnet_opt_strbuf);
  if (FLAG_CHECK (shell->debug_zcmdsh, DEBUG_TYPE (ZCMDSH, TELNET)))
    fprintf (shell->terminal, "IAC %s %s.%s",
             telnet_cmd_strbuf, telnet_opt_strbuf, shell->NL);
  fflush (shell->terminal);
}
...
vty_shell_keyfunc_sb_start (struct shell *shell)
{
  ...
  if (FLAG_CHECK (shell->debug_zcmdsh, DEBUG_TYPE (ZCMDSH, TELNET)))
    fprintf (shell->terminal, "IAC SB (%#hhx).%s",
             shell->inputch, shell->NL);
  fflush (shell->terminal);
}
...
vty_shell_keyfunc_sb_end (struct shell *shell)
{
  ...
  if (FLAG_CHECK (shell->debug_zcmdsh, DEBUG_TYPE (ZCMDSH, TELNET)))
    fprintf (shell->terminal, "IAC SE (%#hhx).%s",
             shell->inputch, shell->NL);
  ...
  if (FLAG_CHECK (shell->debug_zcmdsh, DEBUG_TYPE (ZCMDSH, TELNET)))
    fprintf (shell->terminal, "telnet_sb: %s%s",
             subnego_str, shell->NL);
