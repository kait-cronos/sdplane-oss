...
**Language:** [English](https://github.com/kait-cronos/sdplane-doc/doc/README.en.md) | **日本語**
...
インストール、設定、実行までの手順は[始めるには](https://github.com/kait-cronos/sdplane-doc/doc/getting-started.ja.md)を参照してください。
