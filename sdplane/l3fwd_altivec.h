...
processx4_step3 (struct rte_mbuf *pkt[FWDSTEP], uint16_t dst_port[FWDSTEP])
{
  ...
  te[0] = (__vector unsigned int) vec_sel (
      (__vector unsigned short) ve[0], (__vector unsigned short) te[0],
      (__vector unsigned short){ 0, 0, 0, 0, 0, 0, 0xffff, 0xffff });

  te[1] = (__vector unsigned int) vec_sel (
      (__vector unsigned short) ve[1], (__vector unsigned short) te[1],
      (__vector unsigned short){ 0, 0, 0, 0, 0, 0, 0xffff, 0xffff });

  te[2] = (__vector unsigned int) vec_sel (
      (__vector unsigned short) ve[2], (__vector unsigned short) te[2],
      (__vector unsigned short){ 0, 0, 0, 0, 0, 0, 0xffff, 0xffff });

  te[3] = (__vector unsigned int) vec_sel (
      (__vector unsigned short) ve[3], (__vector unsigned short) te[3],
      (__vector unsigned short){ 0, 0, 0, 0, 0, 0, 0xffff, 0xffff });
...
process_packet (struct rte_mbuf *pkt, uint16_t *dst_port)
{
  ...
  te = (__vector unsigned int) vec_sel (
      (__vector unsigned short) ve, (__vector unsigned short) te,
      (__vector unsigned short){ 0, 0, 0, 0, 0, 0, 0xffff, 0xffff });
      ...
      for (j = FWDSTEP; j != k; j += FWDSTEP)
        {
           ...
           */
          dp2 = *((__vector unsigned short *) &dst_port[j - FWDSTEP + 1]);
